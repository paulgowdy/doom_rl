...
class Application(object):
  ...
  def run(self):
    ...
    if checkpoint and checkpoint.model_checkpoint_path:
      ...
      # set wall time
      wall_t_fname = flags.load_dir + '/' + 'wall_t.' + str(self.global_t)
  ...
  def save(self):
    ...
    wall_t_fname = flags.save_dir + '/' + 'wall_t.' + str(self.global_t)

    with open(wall_t_fname, 'w') as f:
      f.write(str(wall_t))

    print('Start saving. Saving to:', flags.save_dir)
    ...
    print('saving score record')

    with open(flags.save_dir + 'score_record.txt', 'w') as f:
      for item in self.reward_collector:
        f.write("%s\n" % item)
