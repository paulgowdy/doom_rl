...
class Trainer(object):
  def __init__(self,
    ...
    self.global_score_record = global_score_record
  ...
  def _process_base(self, sess, global_t, summary_writer, summary_op, score_input):
    ...
    for _ in range(self.local_t_max):
      ...
      if terminal:
        terminal_end = True
        print(self.thread_index, "score={}".format(self.episode_reward))

        self._record_score(sess, summary_writer, summary_op, score_input,
                           self.episode_reward, global_t)

        # append to global score record here...

        self.global_score_record.append([self.thread_index, self.episode_reward])
